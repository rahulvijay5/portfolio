  ...
  return (
    ...
    >
      <Image
        ...
        layout="fill"
        objectFit="cover"
        className={`transition-opacity duration-1000 ${isLoaded ? 'opacity-60' : 'opacity-0'}`}
      ...
      >
        ...
        <div className="text-xl md:text-2xl font-light absolute top-60 md:mt-2 md:top-48 tracking-widest text-center">
          <span className="inline-block mx-2 transform hover:scale-110 transition-transform duration-300"><Link href={"#traveler"}>TRAVELER</Link></span>
          <span className="inline-block mx-2">|</span>
          <span className="inline-block mx-2 transform hover:scale-110 transition-transform duration-300"><Link href={"#photographer"}>PHOTOGRAPHER</Link></span>
          <span className="inline-block mx-2">|</span>
          <span className="inline-block mx-2 transform hover:scale-110 transition-transform duration-300"><Link href={"#adventurer"}>ADVENTURER</Link></span>
        </div>
        <div className="absolute bottom-10 left-0 right-0 flex justify-between px-8 text-sm font-light">
          <span className="transform hover:scale-110 transition-transform duration-300">ISSUE 01</span>
          <span className="transform hover:scale-110 transition-transform duration-300">2024</span>
        </div>
      </div>
