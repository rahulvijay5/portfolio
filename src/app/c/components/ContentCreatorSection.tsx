...
const ContentCreatorSection: React.FC = () => {
  return (
    <section
      className=" bg-purple-100 dark:bg-gray-900 md:h-screen flex items-center justify-center md:snap-start  py-6 px-4"
      id="content_creator"
    >
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-800 dark:text-gray-300">
                    Led a team of 20 creatives for event coverage
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-800 dark:text-gray-300">
                    Guided juniors in videography techniques
                  </span>
                </li>
                <li className="flex items-start">
